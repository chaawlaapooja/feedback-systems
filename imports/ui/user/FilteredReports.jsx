...
class FilteredReports extends React.Component{
	constructor(){
		super();
		this.state={
			device:'',
	...
	initializeChart(options) {
      ...
      let device = this.refs.id.value!==''?Device.find({id:this.refs.id.value}).fetch():undefined
      let data = device!==undefined?sumObjectsByKey(...device[0].feedbacks):{}
    ...
    generateReport(){
    	printJS({ printable: 'print-form', type: 'html',modalMessage: 'Retrieving Document...',targetStyles: ['*'],header: 'Device wise Filtered Report' })
    }
	getDevices(){
    		...
    		<h1 className="h3 mb-2 text-gray-800">Feedback Analysis</h1>
		   	...
		   	<div className="card shadow mb-4">
		            <div className="card-header py-3">
		              <h6 className="m-0 font-weight-bold text-primary">Feedback by numbers for device ID {this.state.device}</h6>
		            </div>
